...
export class TabList extends React.Component<TAllProps, ITabListState> {
  ...
  public render() {
    const { highlightedItemIndex } = this.state;
    const { tabs, recentlyAudibleTabs, showAudibleTabsOnly, multipleHighlights, toggleMultipleHighLights } = this.props;
    const recentlyAudibleTabsIndexOffset = tabs.length;
        ...
        {tabs.map((tab, index) => {
          ...
          return (
            <SearchListItem
              ...
              toggleMultipleHighLights={toggleMultipleHighLights}
